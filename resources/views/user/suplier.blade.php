                ...
                <table class="table" id="datatabel">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->address }}</td>
                            <td>
                                <span><a class="badge bg-warning text-dark" onclick="get({{$data->id}})" href="javascript:;">Ubah</a></span>
                                <span><a class="badge bg-secondary text-light" href="{{ route('suplier.edit', $data->id) }}">{{ ($data->status == 1)?'Non Aktifkan':'Aktifkan' }}</a></span>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<div class="modal fade" id="newModal" tabindex="-1" aria-labelledby="newModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-header bg-light">
          <h5 class="modal-title" id="newModalLabel">Tambah Suplier</h5>
        ...
        <div class="modal-body">
            <form action="{{ url('user/suplier') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-input row mb-2">
                    <label for="" class="label-form-col col-md-4">Nama Suplier</label>
                    <div class="col-md-8">
                ...
                <div class="form-input row mb-2">
                    <label for="" class="label-form-col col-md-4">No. Telpon Suplier</label>
                    <div class="col-md-8">
                ...
                <div class="form-input row mb-2">
                    <label for="" class="label-form-col col-md-4">Alamat Suplier</label>
                    <div class="col-md-8">
                ...
                {{-- <div class="form-input row mb-2">
                    <label for="" class="label-form-col col-md-4">Foto Suplier</label>
                    <div class="col-md-8">
